        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0 25px 0 25px;">
            <div class="form-group row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <strong>Code</strong>
                    <input class="form-control" name="Code" value="{{old('Code',$client->Code)}}" type="text">
                </div>

                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <strong>Nom</strong>
                    <input class="form-control" name="Nom" type="text" value="{{ old('Nom',$client->Nom) }}" required>
                    @if ($errors->has('Nom'))
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="Email" type="text" value="{{old('Email',$client->Email)}}"
                            required>
                    </div>
                    @if ($errors->has('Email'))
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control" name="Adresse" value="{{old('Adresse',$client->Adresse)}}" type="text">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" name="Telephone" value="{{old('Telephone',$client->Telephone)}}"
                            type="text" required>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <strong>Fax</strong>
                    <input class="form-control" name="Fax" value="{{old('Fax',$client->Fax)}}" type="text">
                    @if ($errors->has('Fax'))
            ...
            <div class="form-group row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <strong>Pays</strong>
                    <input class="form-control" name="Pays" value="{{old('Pays',$client->Pays)}}" type="text">
                    @if ($errors->has('Pays'))
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <strong>Ville</strong>
                    <input class="form-control" name="Ville" value="{{old('Ville',$client->Ville)}}" type="text">
                    @if ($errors->has('Ville'))
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control" name="CodePostal" value="{{old('CodePostal',$client->CodePostal)}}"
                        type="text">
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <!-- <strong></strong> -->
                    <label><input name="Status" type="checkbox" value="on" @if((!old() && $client->Status) ||
                        old('Status') == 'on') checked="checked" @endif>
