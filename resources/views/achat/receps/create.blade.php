...
{!! Form::open(array('route' => 'receps.store','method'=>'POST')) !!}
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input class="form-control" name="Reference" value="@if($cmde!='') {{old('Reference',generateRecepAchat())}}  @endif" type="text">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control datepicker" name="DateReception" value="{{old('DateReception')}}" type="text" required>
                                </div>
