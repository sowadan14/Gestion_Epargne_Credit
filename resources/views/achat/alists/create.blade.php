...
{!! Form::open(array('route' => 'alists.store','method'=>'POST')) !!}
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0 25px 0 25px;">
                <div class="form-group row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <input class="form-control" name="Reference" value="{{old('Reference',generateCmdeAchat())}}" type="text">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <input class="form-control datepicker text-center" name="DateAchat" value="{{old('DateAchat','')}}" type="text">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                        ...
                        <input class="form-control datepicker text-center" name="DateReception" value="{{old('DateReception','')}}" type="text">
