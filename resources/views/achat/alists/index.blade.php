...
<div class="EnteteContent">
    <div class="row">
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 styleEntete">
            <i class=" icon-cart31 bigger-130"></i> Gestion achats
        </div>
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
            ...
            <div class="btn-group dropleft" style="float: right;">
                ...
                <ul class="dropleft dropdown-menu dropdown-inverse">
                    @can('createalist')
                    <li>
                        <a href="{{ route('alists.create') }}" style="vertical-align: inherit;"><span class="glyphicon glyphicon-plus blue"></span> Nouvel achat</a>
                    </li>
                    @endcan
                                            ...
                                            <ul class="dropleft dropdown-menu dropdown-inverse">
                                                <li>
                                                    <p style="min-width:250px;margin:0 0 0px;">
                                                        <a href="{{ route('alists.show',$row->id) }}" style="padding-bottom:4px;" class="btn btn-white btn-xs bolder"><span class="ace-icon fa fa-eye dark"></span> Aperçu</a>

                                                        @can('editalist')

                                                        <a href="{{ route('alists.edit',$row->id) }}" style="padding-bottom:0px;" class="btn btn-warning btn-xs bolder"><span class="glyphicon glyphicon-edit"></span>
                                                            Modifier</a>
                                                        ...
                                                        <!-- {!! Form::open(['method' => 'DELETE','route' => ['alists.destroy',
...
<script type="text/javascript">
    ...
    $('.show_confirm').click(function(event) {
        ...
        $("#SubmitForm").attr('action', '/achat/alists/' + id);
