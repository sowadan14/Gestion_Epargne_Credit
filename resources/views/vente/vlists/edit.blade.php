...
{!! Form::model($cmde, ['method' => 'PATCH','route' => ['vlists.update', $cmde->id]]) !!}

<div class="EnteteContent">
    <div class="row">

        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 styleEntete">
            <i class=" icon-cart32 bigger-130"></i> Gestion ventes
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" style="margin-top:5px;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"><input class="form-control text-right remiseglobale" name="Remiseglobale" value="{{old('Remiseglobale',0)}}" type="number" style="min-width:100px;height:23px;background:gainsboro;border: 2px solid maroon;"></div>
                    <!-- </tr>
                        <tr> -->
                        ...
                        <tbody id="DetailsUnites">
                           ...
                           @if( $unite!='' && $cmde_produit->pivot->UniteId==$unite->id)
                            <tr class='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}'>
                                ...
                                <td><input class='text-right form-control' list='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}' name='Qte[]' min='0' max="{{$cmde_produit->pivot->Qte}}" value="{{$cmde_produit->pivot->Qte}}" type='number' required /></td>
...
<div class="form-group" style="float:right;margin:15px;">
    <a href="{{url('/vente/vlists')}}" class="btn btn-success btn-sm"><span class="dark bolder"><i class="glyphicon glyphicon-list"></i> Liste des ventes</span></a>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        localStorage.setItem("myclass", 'listvente');
        ...
        function getCltAvoir() {
            ...
            if (ClientId != "") {
                $.ajax({
                    url: "{{url('vente/vlists/getCltAvoir')}}",
                    method: 'POST',
                    dataType: 'json',
                    data: {
                        id: ClientId
        ...
        $("#navMenus").on('click', 'li.selector', function() {
            ...
            if (produitId != "") {
                ...
                $.ajax({
                    url: "{{url('vente/vlists/getUnites')}}",
                    method: 'POST',
                    dataType: 'json',
                    data: {
                        id: produitId
        ...
        function CalculeSumChamps(tableID) {
            ...
            $("#" + tableID + " tbody#DetailsUnites tr").each(function() {
                ...
                $(this).find("td").eq(9).html(toNumberFormat(montantttc));
            });
