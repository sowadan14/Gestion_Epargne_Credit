        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
            ...
            <div class="btn-group dropleft" style="float: right;">
                ...
                <ul class="dropleft dropdown-menu dropdown-inverse">
                    @can('createvcmde')
                    <li>
                        <a href="{{ route('vcmdes.create') }}" style="vertical-align: inherit;"><span class="glyphicon glyphicon-plus blue"></span> Nouvelle commande</a>
                    </li>
                    @endcan
                        ...
                        <table class="table table-bordered table-stripped data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ \Carbon\Carbon::parse($row->DateVente)->format('d/m/Y')}}</td>
                                    <td>{{ $row->Reference }}</td>
                                            ...
                                            <ul class="dropleft dropdown-menu dropdown-inverse">
                                                <li>
                                                    <p style="min-width:250px;margin:0 0 0px;">
                                                        <a href="{{ route('vcmdes.show',$row->id) }}" style="padding-bottom:4px;" class="btn btn-white btn-xs bolder"><span class="ace-icon fa fa-eye dark"></span> Aperçu</a>

                                                        @can('editvcmde')

                                                        <a href="{{ route('vcmdes.edit',$row->id) }}" style="padding-bottom:0px;" class="btn btn-warning btn-xs bolder"><span class="glyphicon glyphicon-edit"></span>
                                                            Modifier</a>

                                                        @endcan
                                                        @can('createvlivr')
                                                        @if($row->MontantTTC > $row->MontantLivre)
                                                        <a href="{{ route('livrs.addlivr',$row->id) }}" style="padding-bottom:0px;" class="btn btn-info btn-xs bolder"><span class="fa fa-truck"></span>
                                                            Réception</a>
                                                        @endif
                                                        @endcan
                                                        ...
                                                        <!-- {!! Form::open(['method' => 'DELETE','route' => ['vcmdes.destroy',
...
<script type="text/javascript">
    ...
    $('.show_confirm').click(function(event) {
        ...
        $("#SubmitForm").attr('action', '/vente/vcmdes/' + id);
