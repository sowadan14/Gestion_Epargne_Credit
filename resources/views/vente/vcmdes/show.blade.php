...
@if($cmde->Status=='0')
    <a href="{{ route('vcmdes.cloturer',$cmde->id) }}" class="btn btn-primary btn-sm bolder"><span class=" bolder"><i class="fa fa-check-circle-o"></i> Clôturer</span></a>
@endif
</div>
