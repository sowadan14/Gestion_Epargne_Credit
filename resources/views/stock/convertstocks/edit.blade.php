...
{!! Form::model($cmde, ['method' => 'PATCH','route' => ['acmdes.update', $cmde->id]]) !!}
                    ...
                    <table class="table table-bordered " id="TableOfData" style="font-size:90%;">
                        ...
                        <tbody id="DetailsUnites">
                            ...
                            <tr class='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}'>
                                ...
                                <td><input class='text-right form-control' list='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}' name='QteRecus[]' min='0' value="{{$cmde_produit->pivot->QteReçu}}" type='number' required /></td>
