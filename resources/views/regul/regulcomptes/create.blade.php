...
{!! Form::open(array('route' => 'regulcomptes.store','method'=>'POST')) !!}
        ...
        <div class="EnteteContent">
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 text-right styleAction">
                    Création d'une régularisation compte
                </div>
            </div>
            <hr class="hrEntete">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    ...
                    <input class="form-control text-right" min='0' id="Montant" name="Montant" value="{{old('Montant')}}" type="text">
                </div>

                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <label style="margin-top:25px;"><input name="Entree" type="checkbox">
...
<div class="form-group" style="float:right;margin:15px;">
    <a href="{{ route('regulcomptes.index') }}" class="btn btn-success btn-sm"><span class="dark bolder"><i class="glyphicon glyphicon-list"></i> Liste des paiements</span></a>
