        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
            ...
            <div class="btn-group dropleft" style="float: right;">
                ...
                <ul class="dropleft dropdown-menu dropdown-inverse">
                    @can('createalist')
                    <li>
                        <a href="{{ route('regulstocks.create') }}" style="vertical-align: inherit;"><span class="glyphicon glyphicon-plus blue"></span> Nouvelle régularisation stock</a>
                    </li>
                    @endcan
                        ...
                        <table class="table table-bordered table-stripped data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <!-- <td>{{ $row->unite->Nom }}</td> -->
                                    <td class="text-center">@if ($row->Entree == 1)
                                    ...
                                    <td class="text-right">
                                        @if($row->Qte == 1)
                                        {{number_format($row->Qte,0,',',' ') }} {{ $row->unite->Nom }}
                                        @else
                                        {{number_format($row->Qte,0,',',' ') }} {{ $row->unite->Nom }}s
                                        @endif
                                    </td>
                                            ...
                                            <ul class="dropleft dropdown-menu dropdown-inverse">
                                                <li>
                                                    <p style="min-width:250px;margin:0 0 0px;">
                                                        ...
                                                        <a href="{{ route('regulstocks.edit',$row->id) }}" style="padding-bottom:0px;" class="btn btn-warning btn-xs bolder"><span class="glyphicon glyphicon-edit"></span>
                                                            Modifier</a>
                                                        ...
                                                        <!-- {!! Form::open(['method' => 'DELETE','route' => ['regulstocks.destroy',
