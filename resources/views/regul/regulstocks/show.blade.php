...
<div class="EnteteContent">
    <div class="row">
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 styleEntete">
            <i class="icon-cart32 bigger-130"></i> Gestion des ventes
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <table class="table table-bordered" id="TableOfData">
                    ...
                    <tbody id="DetailsUnites">
                        ...
                        <tr class='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}'>
                            ...
                            <td class='text-right'>{{number_format($cmde_produit->pivot->QteLivre,0,',',' ')}}</td>
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                <table class="table" style="font-size:80%;">
                    ...
                    <tr>
                        <td class="bolder">MONTANT PAYE :</td>
                        <td class="text-right"><span class="">{{number_format($cmde->MontantPaye,0,',',' ') }}</span></td>
                    </tr>
                    <tr>
...
<div class="form-group" style="float:right;margin:15px;">
    ...
    @if($cmde->Status=='0')
    <a href="{{ route('cmdes.cloturer',$cmde->id) }}" class="btn btn-primary btn-sm bolder"><span class=" bolder"><i class="fa fa-check-circle-o"></i> Clôturer</span></a>
    @endif
</div>
