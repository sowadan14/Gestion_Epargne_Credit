...
<div class="col-sm-12 col-xs-12 col-md-10 col-lg-10">
    ...
    {!! Form::open(array('route' => 'prodts.store','method'=>'POST', 'enctype'=>'multipart/form-data')) !!}
                ...
                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" style="padding:0 25px 0 25px;">
                    <div class="form-group row">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div>
                                <select name="TypeProduitId" id="TypeProduitId">
                                    ...
                                    <option value="{{$typeproduit->id}}" {{ (old('TypeProduitId')==$typeproduit->id) ? 'selected' : ''}}>
                                        {{$typeproduit->Nom}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <input class="form-control" name="Libelle" value="{{old('Libelle')}}" type="text">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div>
                                <select name="CategProduitId" id="CategProduitId">
                                    ...
                                    <option value="{{$categproduit->id}}" {{ (old('CategProduitId')==$categproduit->id) ? 'selected' : ''}}>
                                        {{$categproduit->Nom}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <input class="form-control" name="CodeBar" value="{{old('CodeBar')}}" type="text">
                    ...
                    <div class="form-group row">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <strong>CUMP</strong>
                            <input class="form-control  text-right" min='0' name="CUMP" value="{{old('CUMP')}}" type="number">
                            @if ($errors->has('CUMP'))
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <input class="form-control text-right" min='0' name="StockSecu" value="{{old('StockSecu')}}" type="number">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3" style="padding:0 25px 0 25px;">
                    ...
                    <div class="form-group row text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <label for="images" class="drop-container">
                            <input type="file" class="form-control form-control-sm" accept="image/*" style="height: 50px;" id="imgInp" value="{{ old('Prod_logo')}}" name="Prod_logo" onchange="preview()">

                            <img id="blah" src="" alt="Photo profil" width="100px" height="100px" style="border-radius:100px;" />
                        </label>
    ...
    <div class="EnteteContent">
        <div class="row">
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 styleEntete">
            <span class="icon-cart4 bigger-150"></span> Conditionnement vente et achat
            </div>
        </div>
        <hr class="hrEntete">
        <!-- <p><button class="btn btn-sm btn-primary"><span class=" glyphicon glyphicon-plus"></span> Nouveau</button></p> -->
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding:0 25px 0 25px;">
                    <div class="form-group row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <p style="font-size:120%;color:#3f6ad8;font-weight:bold;"></p>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding:5px;">
                                ...
                                <select name="SelectUniteId" id="SelectUniteId">
                                    ...
                                    @foreach($unites as $unite)
                                    <option value="{{$unite->id}}" {{ (old('SelectUniteId')==$unite->id) ? 'selected' : ''}}>
                                        {{$unite->Nom}}
                                    </option>
                                    @endforeach
                                </select>
    ...
    $(document).ready(function() {
        ...
        if ($('.Unite' + cat_id).length < 1 && cat_id != "") {
            $("#DetailsUnites").append("<tr  class='Unite" + cat_id + "'>\
                      ...
                      <td><input class='form-control text-right' name='Qte[]' min='0' value='0' type='text'  /></td>\
                     <td><input class='form-control text-right' name='PrixAchat[]' value='0'   min='0' type='number' required /></td>\
                      <td><input class='form-control text-right' name='PrixVente[]' value='0'  min='0' type='number' required /></td>\
