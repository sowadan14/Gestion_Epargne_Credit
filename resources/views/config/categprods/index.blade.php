			...
			<div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
				...
				<div class="btn-group dropleft" style="float: right;">
					...
					<ul class="dropleft dropdown-menu dropdown-inverse">
						@can('createcategproduit')
						<li>
							<a href="{{ route('categprods.create') }}" style="vertical-align: inherit;"><span class="glyphicon glyphicon-plus blue"></span> Nouvelle famille produit</a>
						</li>
						@endcan
												...
												<ul class="dropleft dropdown-menu dropdown-inverse">
													<li>
														<p style="min-width:250px;margin:0 0 0px;">
															<a href="{{ route('categprods.show',$row->id) }}" style="padding-bottom:4px;" class="btn btn-white btn-xs bolder"><span class="ace-icon fa fa-eye dark"></span> Aperçu</a>

															@can('editcategproduit')

															<a href="{{ route('categprods.edit',$row->id) }}" style="padding-bottom:0px;" class="btn btn-warning btn-xs bolder"><span class="glyphicon glyphicon-edit"></span>
																Modifier</a>

															@endcan


															@can('deletecategproduit')

															<!-- {!! Form::open(['method' => 'DELETE','route' => ['categprods.destroy',
...
<script type="text/javascript">
	$('.show_confirm').click(function(event) {
		...
		$("#SubmitForm").attr('action', '/config/categprods/' + id);
