			...
			<div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
				...
				<div class="btn-group dropleft" style="float: right;">
					...
					<ul class="dropleft dropdown-menu dropdown-inverse">
						@can('createposte')
						<li>
							<a href="{{ route('postes.create') }}" style="vertical-align: inherit;"><span class="glyphicon glyphicon-plus blue"></span> Nouveau poste</a>
						</li>
						@endcan
												...
												<ul class="dropleft dropdown-menu dropdown-inverse">
													<li>
														<p style="min-width:250px;margin:0 0 0px;">
															<a href="{{ route('postes.show',$row->id) }}" style="padding-bottom:4px;" class="btn btn-white btn-xs bolder"><span class="ace-icon fa fa-eye dark"></span> Aperçu</a>

															@can('editposte')

															<a href="{{ route('postes.edit',$row->id) }}" style="padding-bottom:0px;" class="btn btn-warning btn-xs bolder"><span class="glyphicon glyphicon-edit"></span>
																Modifier</a>
															...
															<!-- {!! Form::open(['method' => 'DELETE','route' => ['postes.destroy',
...
<script type="text/javascript">
	$('.show_confirm').click(function(event) {
		...
		$("#SubmitForm").attr('action', '/config/postes/' + id);
...
<script type="text/javascript">
	$(function() {
		...
		$('body').on('click', '.editPoste', function() {
			...
			$.get("{{ route('postes.index') }}" + '/' + poste_id + '/edit', function(data) {
		...
		$('body').on('click', '.deletePoste', function() {
			...
			$("#deleteForm").attr('action', '/postes/' + id);
