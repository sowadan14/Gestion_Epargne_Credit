	...
	<div class="EnteteContent">
		<div class="row">
			...
			<div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 styleEntete">
				<i class="icon-money  bigger-130"></i> Gestion des modes de paiement
			...
			<div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
				...
				<div class="btn-group dropleft" style="float: right;">
					...
					<ul class="dropleft dropdown-menu dropdown-inverse">
						@can('createmodepaiement')
						<li>
							<a href="{{ route('mpaiements.create') }}" style="vertical-align: inherit;"><span class="glyphicon glyphicon-plus blue"></span> Nouveau mode de paiement</a>
						</li>
						@endcan
												...
												<ul class="dropleft dropdown-menu dropdown-inverse">
													<li>
														<p style="min-width:250px;margin:0 0 0px;">
															<a href="{{ route('mpaiements.show',$row->id) }}" style="padding-bottom:4px;" class="btn btn-white btn-xs bolder"><span class="ace-icon fa fa-eye dark"></span> Aperçu</a>

															@can('editmodepaiement')

															<a href="{{ route('mpaiements.edit',$row->id) }}" style="padding-bottom:0px;" class="btn btn-warning btn-xs bolder"><span class="glyphicon glyphicon-edit"></span>
																Modifier</a>

															@endcan


															@can('deletemodepaiement')

															<!-- {!! Form::open(['method' => 'DELETE','route' => ['mpaiements.destroy',
													$row->id],'style'=>'display:inline','id'=>'SubmitForm']) !!} -->

															<a data-id="{{ $row->id }}" role="{{ $row->Nom }}" class="show_confirm btn btn-danger btn-xs bolder"><span class="ace-icon fa fa-trash-o bigger-120"></span>
																Supprimer</a>
...
<script type="text/javascript">
	$('.show_confirm').click(function(event) {
		...
		$("#SubmitForm").attr('action', '/config/mpaiements/' + id);
