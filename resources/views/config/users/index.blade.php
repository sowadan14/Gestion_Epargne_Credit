            ...
            <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
                ...
                <div class="btn-group dropleft" style="float: right;">
                    ...
                    <ul class="dropleft dropdown-menu dropdown-inverse">
                        @can('createuser')
                        <li>
                            <a href="{{ route('users.create') }}" style="vertical-align: inherit;"><span
                                    class="glyphicon glyphicon-plus blue"></span> Nouvel utilisateur</a>
                        </li>
                        @endcan
                            ...
                            <table class="table table-bordered table-stripped data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($row->ImageUser)
                                            <img id="blah" src="{{ asset('storage/images/'.$row->ImageUser) }}"
                                                alt="User photo" width="20px" height="20px"
                                                style="border-radius:100px;" />
                                            @endif
                                            {{ $row->employe->Nom }} {{ $row->employe->Prenoms }}
                                        </td>
                                        <td>{{ $row->email }}</td>
                                        <td>
                                            ...
                                            <div class="btn-group dropleft" style="float: center;">
                                                ...
                                                <ul class="dropleft dropdown-menu dropdown-inverse">
													...
													$row->id],'style'=>'display:inline','id'=>'SubmitForm']) !!} -->
                                                            ...
                                                            <a data-id="{{ $row->id }}" role="{{ $row->email }}"
...
$('.show_confirm').click(function(event) {
    ...
    $("#SubmitForm").attr('action', '/config/users/' + id);
