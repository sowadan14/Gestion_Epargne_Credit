...
$(function() {
    ...
    $('body').on('click', '.editPoste', function() {
        ...
        $.get("{{ route('employes.index') }}" + '/' + poste_id + '/edit', function(data) {
            $('#modelHeading').html(
                "<i class='glyphicon glyphicon-edit'></i> Modification d'un poste");
    ...
    $('body').on('click', '.showPoste', function() {
        ...
        $.get("{{ route('employes.index') }}" + '/' + poste_id + '/edit', function(data) {
            ...
            "<i class='ace-icon fa fa-eye'></i> Details d'un poste");
    ...
    $('body').on('click', '.deletePoste', function() {
        ...
        $('#deleteModelHeading').html(
            "<i class='ace-icon fa fa-trash-o bigger-120'></i> Suppression d'un poste");
