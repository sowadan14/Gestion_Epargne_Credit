...
{!! Form::open(array('route' => 'vfacts.store','method'=>'POST')) !!}
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div>
                                    <select name="LivraisonId" id="LivraisonId">
                                        ...
                                        <option value="{{$Livr->id}}" {{ ($Livr->id==$livr->id) ? 'selected' : ''}} {{ (old('LivraisonId')==$Livr->id) ? 'selected' : ''}}>
                                            {{$Livr->Reference}}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input class="form-control" name="Reference" value="{{old('Reference',generateFactVente())}}" type="text">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control datepicker" name="DateFacture" value="{{old('DateFacture')}}" type="text" required>
                                </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control datepicker" name="DateEcheance" value="{{old('DateEcheance')}}" type="text" required>
                                </div>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            {{ \Carbon\Carbon::parse($livr->DateLivraisonId)->format('d/m/Y')}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            {{ \Carbon\Carbon::parse($livr->commande->DateVente)->format('d/m/Y')}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            if(($livr->commande->MontantLivre/$livr->commande->MontantTTC)*100 < 99.9999 && ($livr->commande->MontantLivre/$livr->commande->MontantTTC)*100 > 99.9)
                                {
                                $StatusLivraisonId=99;
                                }
                                else
                                {
                                $StatusLivraisonId=round(($livr->commande->MontantLivre/$livr->commande->MontantTTC)*100);
                                }
                                @endphp

                                <div class="progress pos-rel" data-percent="{{$StatusLivraisonId}}%">
                                    <div class="progress-bar" style="width:{{$StatusLivraisonId}}%;"></div>
                                </div>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered " id="TableOfData" style="font-size:90%;">
                    ...
                    <tbody id="DetailsUnites">
                        ...
                        <tr class='PUnite{{$livr_produit->pivot->UniteId}}{{$livr_produit->id}}'>
                            ...
                            <td><input class='text-right form-control' list='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}' name='Qte[]' min='0' max="{{$livr_produit->pivot->Qte-$livr_produit->pivot->QteFacture}}" value="{{$livr_produit->pivot->Qte-$livr_produit->pivot->QteFacture}}" type='number' required />
                            </td>
                            ...
                            <td hidden><input class='text-right form-control' list='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}' name='Produit[]' min='0' value="{{$livr_produit->id}}" type='number' />
                            </td>

                            <td hidden><input class='text-right form-control' list='PUnite{{$cmde_produit->pivot->UniteId}}{{$cmde_produit->id}}' name='Unite[]' min='0' value="{{$livr_produit->pivot->UniteId}}" type='number' />
                            </td>
                        </tr>
                        @break
                        @endif
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#LivraisonId').chosen();
        $("#LivraisonIdId_chosen").css("width", "100%");
