...
<div class="EnteteContent">
    <div class="row">
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 styleEntete">
            <i class="icon-money bigger-130"></i> Etat client
        </div>
...
<div class="EnteteContent">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        ...
                        {!! Form::open(array('route' => 'etatclts.store','method'=>'POST','id'=>'SubmitForm')) !!}
                        <div>
                            <select name="ClientId" id="ClientId">
                                <option value="">Séléctionner un client</option>
                                @foreach($clients as $client)
                                <option value="{{$client->id}}" {{ ($CltId==$client->id) ? 'selected' : ''}} {{ (old('ClientId')==$client->id) ?
                                    'selected' : ''}}>
                                    {{$client->Nom}}
                                </option>
                                @endforeach
