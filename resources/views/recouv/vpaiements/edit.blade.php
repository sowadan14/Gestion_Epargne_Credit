...
{!! Form::model($paiement, ['method' => 'PATCH','route' => ['vpaiements.update', $paiement->id]]) !!}
        ...
        <div class="EnteteContent">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control text-right" min='0' id="MontantRemis" name="MontantRemis" value="{{old('MontantRemis',$vfact->MontantFacture-$vfact->MontantPaye+$paiement->Montant)}}" type="text">
                    <input class="form-control text-right hidden" min='0' id="TotalAPayer" name="TotalAPayer" value="{{old('TotalAPayer',$vfact->MontantFacture-$vfact->MontantPaye+$paiement->Montant)}}" type="text">
        ...
        <div class="EnteteContent">
            ...
            <div class=" detailsfact">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <strong>Montant payé:</strong> {{number_format($vfact->MontantPaye-$paiement->Montant,0,',',' ') }}
                            {{ auth()->user()->entreprise->Devise}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <strong>Reste à payer:</strong> {{number_format($vfact->MontantFacture-$vfact->MontantPaye+$paiement->Montant,0,',',' ') }}
                            {{ auth()->user()->entreprise->Devise}}
                        </td>
                    </tr>
