            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Date livraison: </strong> {{\Carbon\Carbon::parse($vfact->livraison->DateLivraison)->format('d/m/Y')}}
                        </div>
                    </div>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Montant livraison: </strong> {{number_format($vfact->livraison->MontantLivre,0,',',' ') }} {{ auth()->user()->entreprise->Devise}}
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 text-right styleAction">
                    <div class="btn-group dropleft" style="float: right;">
                       ...
                       @if($vfact->MontantFacture-$vfact->MontantPaye!=0)
                            @can('createvpaiement')
                            <li>
                                <a href="{{ route('vpaiements.addpaiement',$vfact->id) }}" style="vertical-align: inherit;"><span class="glyphicon glyphicon-plus blue"></span> Nouveau paiement</a>
                            </li>
                            @endcan
                            @endif
                                ...
                                <table class="table table-bordered table-stripped data-table" style="font-size:80%;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $row->Reference }}</td>
                                            <!-- <td>{{ $row->facture->livraison->commande->client->Nom }}</td> -->
                                            <!-- <td>{{ $row->facture->livraison->commande->Reference}}</td>
                                    <td>{{ $row->facture->livraison->Reference }}</td> -->
                                                    ...
                                                    <ul class="dropleft dropdown-menu dropdown-inverse">
                                                        <li>
                                                            <p style="min-width:250px;margin:0 0 0px;">
                                                                <a href="{{ route('vpaiements.show',$row->id) }}" style="padding-bottom:4px;" class="btn btn-white btn-xs bolder"><span class="ace-icon fa fa-eye dark"></span> Aperçu</a>

                                                                @can('editvpaiement')

                                                                <a href="{{ route('vpaiements.edit',$row->id) }}" style="padding-bottom:0px;" class="btn btn-warning btn-xs bolder"><span class="glyphicon glyphicon-edit"></span>
                                                                    Modifier</a>

                                                                @endcan
                                                                @can('deletevpaiement')

                                                                <!-- {!! Form::open(['method' => 'DELETE','route' => ['vpaiements.destroy',
        ...
        <div class="EnteteContent">
            ...
            <div class=" detailsfact">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            <strong>Réference facture:</strong> {{$vfact->Reference}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <strong>Remise globale:</strong> {{number_format($vfact->Remise,0,',',' ') }}
                            {{ auth()->user()->entreprise->Devise}}
                        </td>
                    </tr>
                    @endif
                    ...
                    <tr>
                        <td>
                            <strong>Montant payé:</strong> {{number_format($vfact->MontantPaye-$vfact->Remise,0,',',' ') }}
                            {{ auth()->user()->entreprise->Devise}}
                        </td>
                    </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.show_confirm').click(function(event) {
            ...
            $("#SubmitForm").attr('action', '/recouv/vpaiements/' + id);
        ...
        $('#LivraisonId').chosen();
        $("#LivraisonId_chosen").css("width", "100%");
        ...
        $(document).on('change', '#LivraisonId', function() {
            ...
            if (LivraisonId != "") {
                $.ajax({
                    url: "{{url('recouv/vpaiements/getDetailsfact')}}",
                    method: 'POST',
                    dataType: 'json',
                    data: {
                        id: LivraisonId
                    ...
                    success: function(data) {
                        $('.detailsfact').html(data.htmlDetailsLivr);
                        $('#DetailsUnites').empty();
