...
{!! Form::open(array('route' => 'vpaiements.store','method'=>'POST')) !!}
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group row ">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Date commande: </strong> {{\Carbon\Carbon::parse($vfact->livraison->commande->DateVente)->format('d/m/Y')}}
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Réference commande: </strong> {{$vfact->livraison->commande->Reference}}
                        </div>
                    </div>

                    <div class="form-group row ">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Montant commande: </strong> {{number_format($vfact->livraison->commande->MontantTTC,0,',',' ') }} {{ auth()->user()->entreprise->Devise}}
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Date réception: </strong> {{\Carbon\Carbon::parse($vfact->livraison->DateLivraison)->format('d/m/Y')}}
                        </div>
                    </div>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Réference réception: </strong> {{$vfact->livraison->Reference}}
                        </div>

                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <strong>Montant réception: </strong> {{number_format($vfact->livraison->MontantLivre,0,',',' ') }} {{ auth()->user()->entreprise->Devise}}
                        </div>
                    </div>
                </div>
        ...
        <div class="EnteteContent">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control" readonly name="ReferenceFacture" value="{{old('ReferenceFacture',$vfact->Reference)}}" type="text">
                    <input class="form-control hidden" name="FactureId" value="{{old('FactureId',$vfact->id)}}" type="text">
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div>
                        <select name="ModePaiementId" id="ModePaiementId">
                            ...
                            <option value="{{$modepaiement->id}}" {{ (old('ModePaiementId')==$modepaiement->id) ? 'selected' : ''}}>
                                {{$modepaiement->Nom}}
                            </option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control" name="Reference" value="{{old('Reference',generatePaiementVente())}}" type="text">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control datepicker" name="DatePaiement" value="{{old('DatePaiement')}}" type="text" required>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control text-right" min='0' id="MontantRemis" name="MontantRemis" value="{{old('MontantRemis',$vfact->MontantFacture-$vfact->MontantPaye)}}" type="text">
                    <input class="form-control text-right hidden" min='0' id="TotalAPayer" name="TotalAPayer" value="{{old('TotalAPayer',$vfact->MontantFacture-$vfact->MontantPaye)}}" type="text">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            {{ \Carbon\Carbon::parse($vfact->DateFacture)->format('d/m/Y')}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            {{ \Carbon\Carbon::parse($vfact->DateEcheance)->format('d/m/Y')}}
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <strong>Montant facture:</strong> {{number_format($vfact->MontantFacture,0,',',' ') }}
                    ...
                    <tr>
                        <td>
                            <strong>Montant payé:</strong> {{number_format($vfact->MontantPaye,0,',',' ') }}
                            {{ auth()->user()->entreprise->Devise}}
                        </td>
                    </tr>
                    ...
                    <tr style="background-color:#cad7fa;">
                        <td>
                            <strong>Reste à payer:</strong> {{number_format($vfact->MontantFacture-$vfact->MontantPaye,0,',',' ') }}
                            {{ auth()->user()->entreprise->Devise}}
                        </td>
                    </tr>
...
<div class="form-group" style="float:right;margin:15px;">
    <a href="{{ route('vpaiements.facture',$vfact->id) }}" class="btn btn-success btn-sm"><span class="dark bolder"><i class="glyphicon glyphicon-list"></i> Liste des paiements</span></a>
