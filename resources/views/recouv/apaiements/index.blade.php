                                            ...
                                            <ul class="dropleft dropdown-menu dropdown-inverse">
                                                <li>
                                                    <p style="min-width:250px;margin:0 0 0px;">
                                                        <a href="{{ route('apaiements.facture',$row->id) }}" style="padding-bottom:4px;" class="btn btn-white btn-xs bolder"><span class="ace-icon fa fa-eye dark"></span> Aperçu</a>

                                                        @can('createapaiement')
                                                        @if($row->MontantFacture>$row->MontantPaye)
                                                        <a href="{{ route('apaiements.addpaiement',$row->id) }}" style="padding-bottom:0px;" class="btn btn-info btn-xs bolder"><span class="icon-money"></span>
                                                             Paiement</a>
                                                        @endif
                                                        @endcan
                                                    </p>
