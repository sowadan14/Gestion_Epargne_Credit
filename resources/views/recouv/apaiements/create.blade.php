...
{!! Form::open(array('route' => 'apaiements.store','method'=>'POST')) !!}
        ...
        <div class="EnteteContent">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control" name="Reference" value="{{old('Reference',generatePaiementAchat())}}" type="text">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control text-right" min='0' id="MontantRemis" name="MontantRemis" value="{{old('MontantRemis',$afact->MontantFacture-$afact->MontantPaye)}}" type="text">
                    <input class="form-control text-right hidden" min='0' id="TotalAPayer" name="TotalAPayer" value="{{old('TotalAPayer',$afact->MontantFacture-$afact->MontantPaye)}}" type="text">
