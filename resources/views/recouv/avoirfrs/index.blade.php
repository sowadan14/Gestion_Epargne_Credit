...
<div class="EnteteContent">
    <div class="row">
        ...
        <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6 styleEntete">
            <i class="icon-money bigger-130"></i> Gestion avoirs fournisseur
        </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
                    <div class="">
                        <table class="table table-bordered table-stripped data-table" style="font-size:90%;width:100%;">
                            <thead>
                                <tr>
                                    <th hidden>N°</th>
...
<script type="text/javascript">
    localStorage.setItem("myclass", 'avoirfr');
